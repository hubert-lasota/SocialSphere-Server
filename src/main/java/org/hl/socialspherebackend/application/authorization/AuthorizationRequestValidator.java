...
public class AuthorizationRequestValidator extends RequestValidator<LoginRequest, AuthorizationValidateResult> {
    ...
    @Override
    public AuthorizationValidateResult validate(LoginRequest requestToValidate) {
        ...
        String username = requestToValidate.username();
        String password = requestToValidate.password();
