...
public class UserProfileRequestValidator extends RequestValidator<UserProfileRequest, UserValidateResult> {
    ...
    @Override
    public UserValidateResult validate(UserProfileRequest requestToValidate) {
        ...
        String firstName = requestToValidate.firstName();
        String lastName = requestToValidate.lastName();
        String city = requestToValidate.city();
        String country = requestToValidate.country();
        ...
        if(!Character.isUpperCase(firstName.charAt(0)) && forceFirstCharUppercase) {
        ...
        if(!Character.isUpperCase(lastName.charAt(0)) && forceFirstCharUppercase) {
        ...
        if(!Character.isUpperCase(city.charAt(0)) && forceFirstCharUppercase) {
        ...
        if(!Character.isUpperCase(country.charAt(0)) && forceFirstCharUppercase) {
